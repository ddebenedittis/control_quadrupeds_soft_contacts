...
template <typename ControlTasksType = ControlTasks>
...
public:
    ...
    [[nodiscard]] int get_nv() const {return control_tasks.get_nv();}
    [[nodiscard]] int get_nF() const {return control_tasks.get_nF();}
    [[nodiscard]] int get_nd() const {return control_tasks.get_nd();}

    [[nodiscard]] double get_mass() const {return control_tasks.get_mass();}

    [[nodiscard]] double get_friction_coefficient() const {return control_tasks.get_friction_coefficient();}

    Eigen::Vector3d get_com_position() {return control_tasks.get_com_position();}

    [[nodiscard]] const Eigen::MatrixXd& get_M()  const {return control_tasks.get_M();}
    [[nodiscard]] const Eigen::VectorXd& get_h()  const {return control_tasks.get_h();}
    [[nodiscard]] const Eigen::MatrixXd& get_Jc() const {return control_tasks.get_Jc();}
    ...
    [[nodiscard]] const std::vector<std::string>& get_generic_feet_names() const {return control_tasks.get_generic_feet_names();}

    [[nodiscard]] const std::vector<std::string>& get_all_feet_names() const {return control_tasks.get_all_feet_names();}

    [[nodiscard]] int get_max_priority() const {return *max_element(tasks_vector.begin(), tasks_vector.end());}

    [[nodiscard]] auto get_contact_constraint_type() const {return this->contact_constraint_type;}

    [[nodiscard]] const Eigen::Vector3d& get_kp_terr() const {return control_tasks.get_kp_terr();}
...
protected:
    ...
    ControlTasksType control_tasks;
